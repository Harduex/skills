...
- `TARGET_WIDTH` (120): the script warns on stderr when the render is wider — an MR review pane clips it behind a horizontal scrollbar. Fix with `"TB"` or shorter labels, never by shipping the scroll.
