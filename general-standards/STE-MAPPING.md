...
| STE | What the source rule requires (paraphrase) | Page | → Skill rule |
|---|---|---|---|
...
| 4.4 | Link sentences on related topics using connecting words and phrases. | 77 | M5, D6 |
| 4.5 | Where it fits, put an article or a demonstrative before nouns. | 77 | P4, D7 |
| 5.1 | Procedural sentences stay within twenty words. | 87 | S1, P1, D1 |
...
| 6.1 | Release information bit by bit. | 93 | M3, P3, D8 |
| 6.2 | Structure text logically around key words and phrases. | 93 | M4, D8 |
| 6.3 | Descriptive sentences stay within twenty-five words. | 93 | P1, D1 |
...
| 8.1 | Standard punctuation is fine; semicolons are the exception and are barred. | 105 | D3 |
| 8.2 | Hyphenate words that belong directly together. | 107 | N6 |
| 8.3 | Parentheses can be used for enumerated purposes: cross-references, item callouts, step labels, abbreviations, singular/plural pairs, explanations, alternatives. | 107 | D4 |
| 8.4 | In vertical lists, a colon closes a sentence for counting purposes, like a period. | 107 | D2 |
| 8.5 | A parenthesized insert adds one to the sentence's word tally. | 107 | D2 |
| 8.6 | Certain elements — numbers, measurements, abbreviations, identifiers, quotations, titles, proper names — each tally as a single word. | 107 | D2 |
| 8.7 | A hyphenated cluster tallies as a single word. | 114 | D2 |
...
| STE | What the source recommends (paraphrase) | Page | → Skill rule |
|---|---|---|---|
...
| GR-8 | The apostrophe-s possessive is allowed but hard on non-native readers — skip it when unsure. | 127 | D5 |

## Part 2 — Dictionary

| STE | What the source provides (paraphrase) | Page | → Skill rule |
|---|---|---|---|
| Part 2 | A closed list of approved words (875), each with its sanctioned meaning and usage examples, plus 1,274 unapproved words, each pointing at approved replacements. Domain vocabulary lives outside the list, in the technical noun/verb categories. | 131 | N1, N2, N3 + the glossary machinery in VOCABULARY.md: its term template, its list of sanctioned verbs, and its list of forbidden words |
...
private source notebook. In contrast, this public table carries only
paraphrases.
