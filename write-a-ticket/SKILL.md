...
## Rules that came from corrections
...
- **Do not file open questions as decoration.** Either resolve the question before filing, or make the decision the ticket's whole purpose and say so in the title. A leftover "decisions to make" section means the ticket is not ready.
